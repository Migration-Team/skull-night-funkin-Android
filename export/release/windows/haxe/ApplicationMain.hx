...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Skull Night Funkin'", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Skull Night Funkin'", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "269";
		app.meta["company"] = "microondas261477";
		app.meta["file"] = "Skull Night Funkin'";
		app.meta["name"] = "Skull Night Funkin'";
		app.meta["packageName"] = "com.microondas.skull";
