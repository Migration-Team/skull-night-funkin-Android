...
class HXCPP_CLASS_ATTRIBUTES Note_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		static void __boot();
		static ::Array< Float > scales;
		static ::Array< int > lessX;
		static ::Array< int > separator;
		static ::Array< int > xtra;
		static ::Array< int > posRest;
		static ::Array< int > gridSizes;
		static ::cpp::VirtualArray offsets;
		static int minMania;
		static int maxMania;
		static int defaultMania;
		static  ::haxe::ds::IntMap keysShit;
		static ::Array< int > ammo;
		static ::Array< Float > pixelScales;
		static Float swagWidth;
		static int PURP_NOTE;
		static int GREEN_NOTE;
		static int BLUE_NOTE;
		static int RED_NOTE;
		::Array< ::String > gfxLetter;
		Float strumTime;
		bool mustPress;
		int noteData;
		bool canBeHit;
		...
		void applyManiaChange();
		::Dynamic applyManiaChange_dyn();
