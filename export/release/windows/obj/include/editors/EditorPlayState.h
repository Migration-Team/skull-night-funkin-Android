...
class HXCPP_CLASS_ATTRIBUTES EditorPlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		void __construct(Float startPos,::hx::Null< int >  __o_songMania);
		...
		static ::hx::ObjectPtr< EditorPlayState_obj > __new(Float startPos,::hx::Null< int >  __o_songMania);
		static ::hx::ObjectPtr< EditorPlayState_obj > __alloc(::hx::Ctx *_hx_ctx,Float startPos,::hx::Null< int >  __o_songMania);
