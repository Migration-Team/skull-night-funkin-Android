...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		int curBFSkin;
		int curGFSkin;
		 ::flixel::_hx_system::FlxSound skinSelectMusic;
		 ::flixel::text::FlxText skinSelectorTxt;
		 ::flixel::FlxSprite bg;
		::Array< ::String > bfCostumes;
		 ::flixel::FlxSprite bfSkin;
		 ::flixel::text::FlxText bfTxt;
		::Array< ::String > gfCostumes;
		 ::flixel::FlxSprite gfSkin;
		 ::flixel::text::FlxText gfTxt;
		 ::flixel::FlxSprite iconBFBG;
		 ::HealthIcon iconBF;
		 ::flixel::FlxSprite iconGFBG;
		 ::HealthIcon iconGF;
		void skinSelector();
		::Dynamic skinSelector_dyn();

		void skinSelectorUpdate();
		::Dynamic skinSelectorUpdate_dyn();

		void changeSkin(::hx::Null< int >  change);
		::Dynamic changeSkin_dyn();

		void changeCharacter(::hx::Null< int >  change);
		...
		void changeMania(int newValue);
		::Dynamic changeMania_dyn();
		...
		bool keysArePressed();
		::Dynamic keysArePressed_dyn();

		bool dataKeyIsPressed(int data);
		::Dynamic dataKeyIsPressed_dyn();
