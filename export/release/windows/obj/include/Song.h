...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_37_new)
...
HXLINE(  52)		( ( ::Song)(__this) )->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  51)		( ( ::Song)(__this) )->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  50)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  49)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  46)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  43)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  95)		( ( ::Song)(__this) )->song = song;
HXLINE(  96)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  97)		( ( ::Song)(__this) )->bpm = bpm;
            	}
