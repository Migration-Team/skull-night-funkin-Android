...
HXLINE(  38)		 ::options::Option option =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Downscroll",0f,4a,85,46),HX_("If checked, notes go Down instead of Up, simple enough.",0d,a5,bc,fc),HX_("downScroll",0f,ba,68,84),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  43)		this->addOption(option);
HXLINE(  45)		 ::options::Option option1 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Middlescroll",42,a5,d6,f5),HX_("If checked, your notes get centered.",9c,98,94,3e),HX_("middleScroll",42,cd,58,62),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  50)		this->addOption(option1);
HXLINE(  52)		 ::options::Option option2 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Ghost Tapping",44,6c,9f,40),HX_("If checked, you won't get misses from pressing keys\nwhile there are no notes able to be hit.",c7,46,2f,fa),HX_("ghostTapping",c6,6a,da,10),HX_("bool",2a,84,1b,41),true,null());
HXLINE(  57)		this->addOption(option2);
HXLINE(  59)		 ::options::Option option3 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("No Antimash",4a,cd,12,85),HX_("If checked, Antimash will be disabled.",26,56,4c,b2),HX_("noAntimash",ec,0e,83,99),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  64)		this->addOption(option3);
HXLINE(  67)		 ::options::Option option4 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Disable Reset Button",bb,b9,2b,75),HX_("If checked, pressing Reset won't do anything.",ee,76,e8,10),HX_("noReset",ce,cd,cb,b9),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  72)		this->addOption(option4);
HXLINE(  74)		 ::options::Option option5 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Hitsound Volume",de,af,92,68),HX_("Funny notes does \"Tick!\" when you hit them.\"",b2,5a,bb,e5),HX_("hitsoundVolume",96,34,9b,8f),HX_("percent",c5,aa,da,78),0,null());
HXLINE(  79)		this->addOption(option5);
HXLINE(  80)		option5->scrollSpeed = ((Float)1.6);
HXLINE(  81)		option5->minValue = ((Float)0.0);
HXLINE(  82)		option5->maxValue = 1;
HXLINE(  83)		option5->changeValue = ((Float)0.1);
HXLINE(  84)		option5->decimals = 1;
