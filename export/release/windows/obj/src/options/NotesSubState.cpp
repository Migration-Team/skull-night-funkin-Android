...
HXLINE(  54)		this->blackBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(this->posX - 25),null(),null())->makeGraphic(870,100,-16777216,null(),null());
...
HXLINE(  64)				Float yPos = ( (Float)(((80 * i) - 40)) );
HXLINE(  65)				{
HXLINE(  65)					{
HXLINE(  66)						 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(0)),true,false,((Float)0.05),((Float)0.8));
HXLINE(  67)						optionText->set_x(( (Float)((this->posX + 250)) ));
HXLINE(  68)						this->grpNumbers->add(optionText).StaticCast<  ::Alphabet >();
            					}
HXLINE(  65)					{
HXLINE(  66)						 ::Alphabet optionText1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(1)),true,false,((Float)0.05),((Float)0.8));
HXLINE(  67)						optionText1->set_x(( (Float)(((this->posX + 225) + 250)) ));
HXLINE(  68)						this->grpNumbers->add(optionText1).StaticCast<  ::Alphabet >();
            					}
HXLINE(  65)					{
HXLINE(  66)						 ::Alphabet optionText2 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),(yPos + 60),::Std_obj::string(::ClientPrefs_obj::arrowHSV->__get(i).StaticCast< ::Array< int > >()->__get(2)),true,false,((Float)0.05),((Float)0.8));
...
HXLINE(  73)				::String animation = (( ( ::haxe::ds::StringMap)(::Note_obj::keysShit->get(::Note_obj::maxMania)) )->get(HX_("letters",cd,9c,8e,04))->__GetItem(i) + HX_("0",30,00,00,00));
HXLINE(  74)				note->animation->addByPrefix(HX_("idle",14,a7,b3,45),animation,null(),null(),null(),null());
...
HXLINE( 210)				item->scale->set(((Float)0.5),((Float)0.5));
HXLINE( 211)				if ((::options::NotesSubState_obj::curSelected == i)) {
HXLINE( 212)					item->set_alpha(( (Float)(1) ));
HXLINE( 213)					item->scale->set(((Float)0.6),((Float)0.6));
HXLINE( 214)					this->hsbText->set_y((item->y - ( (Float)(40) )));
HXLINE( 215)					this->blackBG->set_y((item->y + 28));
            				}
            			}
            		}
