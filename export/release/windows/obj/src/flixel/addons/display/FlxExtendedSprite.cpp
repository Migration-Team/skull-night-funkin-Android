...
HXLINE( 230)		if (::hx::IsNull( ::flixel::FlxG_obj::plugins->get(::hx::ClassOf< ::flixel::addons::plugin::FlxMouseControl >()) )) {
...
HXLINE( 265)		if (::hx::IsNull( ::flixel::FlxG_obj::plugins->get(::hx::ClassOf< ::flixel::addons::plugin::FlxMouseControl >()) )) {
...
HXLINE( 314)		if (::hx::IsNull( ::flixel::FlxG_obj::plugins->get(::hx::ClassOf< ::flixel::addons::plugin::FlxMouseControl >()) )) {
...
HXLINE( 377)		if (::hx::IsNull( ::flixel::FlxG_obj::plugins->get(::hx::ClassOf< ::flixel::addons::plugin::FlxMouseControl >()) )) {
