...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_44_swapOldIcon,"HealthIcon","swapOldIcon",0xe3496dd4,"HealthIcon.swapOldIcon","HealthIcon.hx",44,0xf7836789)
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_54_changeIcon,"HealthIcon","changeIcon",0xd785ca82,"HealthIcon.changeIcon","HealthIcon.hx",54,0xf7836789)
static const int _hx_array_data_f8f9be55_5[] = {
	(int)0,(int)1,(int)2,
};
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_83_updateHitbox,"HealthIcon","updateHitbox",0x4656523a,"HealthIcon.updateHitbox","HealthIcon.hx",83,0xf7836789)
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_91_bounce,"HealthIcon","bounce",0x5592c281,"HealthIcon.bounce","HealthIcon.hx",91,0xf7836789)
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_101_getCharacter,"HealthIcon","getCharacter",0x409335ec,"HealthIcon.getCharacter","HealthIcon.hx",101,0xf7836789)
...
HXLINE(  50)		this->iconOffsets = ::Array_obj< Float >::fromData( _hx_array_data_f8f9be55_1,3);
...
HXLINE(  34)		if (this->canBounce) {
HXLINE(  36)			Float mult = (1 + (::Math_obj::max(( (Float)(0) ),::Math_obj::min(( (Float)(1) ),(( (Float)(1) ) - (elapsed * ( (Float)(9) ))))) * (this->scale->x - ( (Float)(1) ))));
HXLINE(  37)			this->scale->set(mult,mult);
...
void HealthIcon_obj::swapOldIcon(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_44_swapOldIcon)
HXDLIN(  44)		if ((this->isOldIcon = !(this->isOldIcon))) {
HXLINE(  45)			this->changeIcon(HX_("bf-old",5e,ba,eb,07));
            		}
            		else {
HXLINE(  47)			this->changeIcon(HX_("bf",c4,55,00,00));
            		}
            	}
...
void HealthIcon_obj::changeIcon(::String _hx_char){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_54_changeIcon)
HXDLIN(  54)		if ((this->_hx_char != _hx_char)) {
HXLINE(  56)			::String name = (HX_("icons/",15,dc,d6,45) + _hx_char);
HXLINE(  57)			::String key = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  57)			bool _hx_tmp;
HXDLIN(  57)			bool _hx_tmp1;
HXDLIN(  57)			::String key1 = ((::Paths_obj::currentModDirectory + HX_("/",2f,00,00,00)) + key);
HXDLIN(  57)			if (::hx::IsNull( key1 )) {
HXLINE(  57)				key1 = HX_("",00,00,00,00);
            			}
HXDLIN(  57)			if (!(::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key1)))) {
HXLINE(  57)				::String key1 = key;
HXDLIN(  57)				if (::hx::IsNull( key1 )) {
HXLINE(  57)					key1 = HX_("",00,00,00,00);
            				}
HXDLIN(  57)				_hx_tmp1 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key1));
            			}
            			else {
...
HXLINE(  57)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  57)					_hx_tmp = true;
            				}
            				else {
...
HXLINE(  58)				name = (HX_("icons/icon-",5f,da,21,72) + _hx_char);
            			}
HXLINE(  59)			::String key2 = ((HX_("images/",77,50,74,c1) + name) + HX_(".png",3b,2d,bd,1e));
HXDLIN(  59)			bool _hx_tmp2;
HXDLIN(  59)			bool _hx_tmp3;
HXDLIN(  59)			::String key3 = ((::Paths_obj::currentModDirectory + HX_("/",2f,00,00,00)) + key2);
HXDLIN(  59)			if (::hx::IsNull( key3 )) {
HXLINE(  59)				key3 = HX_("",00,00,00,00);
            			}
HXDLIN(  59)			if (!(::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key3)))) {
HXLINE(  59)				::String key = key2;
HXDLIN(  59)				if (::hx::IsNull( key )) {
HXLINE(  59)					key = HX_("",00,00,00,00);
            				}
HXDLIN(  59)				_hx_tmp3 = ::sys::FileSystem_obj::exists((HX_("mods/",9e,2f,58,0c) + key));
            			}
            			else {
...
HXLINE(  59)				if (::openfl::utils::Assets_obj::exists(::Paths_obj::getPath(key2,HX_("IMAGE",3b,57,57,3b),null()),null())) {
HXLINE(  59)					_hx_tmp2 = true;
            				}
            				else {
...
HXLINE(  60)				name = HX_("icons/icon-face",7c,aa,dd,e7);
            			}
HXLINE(  61)			::String library = null();
HXDLIN(  61)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(name,library);
HXDLIN(  61)			 ::Dynamic file = returnAsset;
HXLINE(  63)			this->loadGraphic(file,null(),null(),null(),null(),null());
HXLINE(  64)			int _hx_tmp4 = ::Math_obj::floor((this->get_width() / ( (Float)(3) )));
HXDLIN(  64)			this->loadGraphic(file,true,_hx_tmp4,::Math_obj::floor(this->get_height()),null(),null());
HXLINE(  65)			this->iconOffsets[0] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(3) ));
HXLINE(  66)			this->iconOffsets[1] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(3) ));
HXLINE(  67)			this->iconOffsets[2] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(3) ));
HXLINE(  68)			this->updateHitbox();
HXLINE(  70)			this->animation->add(_hx_char,::Array_obj< int >::fromData( _hx_array_data_f8f9be55_5,3),0,false,this->isPlayer,null());
HXLINE(  71)			this->animation->play(_hx_char,null(),null(),null());
HXLINE(  72)			this->_hx_char = _hx_char;
HXLINE(  74)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  75)			if (::StringTools_obj::endsWith(_hx_char,HX_("-pixel",39,03,b3,c0))) {
HXLINE(  77)				this->set_antialiasing(false);
            			}
            		}
            	}
...
void HealthIcon_obj::updateHitbox(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_83_updateHitbox)
HXLINE(  84)		this->super::updateHitbox();
HXLINE(  85)		this->offset->set_x(this->iconOffsets->__get(0));
HXLINE(  86)		this->offset->set_y(this->iconOffsets->__get(1));
            	}


void HealthIcon_obj::bounce(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_91_bounce)
HXDLIN(  91)		if (this->canBounce) {
HXLINE(  93)			Float mult = ((Float)1.2);
HXLINE(  94)			this->scale->set(mult,mult);
...
::String HealthIcon_obj::getCharacter(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_101_getCharacter)
HXDLIN( 101)		return this->_hx_char;
            	}
