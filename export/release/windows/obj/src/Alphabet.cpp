...
HXLINE( 211)		 ::Alphabet _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 255)				 ::Alphabet _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 255)				_g->set_y((_g->y + this->LONG_TEXT_ADD));
            			}
            		}
...
HXLINE( 322)				{
HXLINE( 322)					 ::AlphaCharacter _g = letter;
HXDLIN( 322)					_g->set_x((_g->x + 90));
            				}
