...
HXDLIN(  35)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuBG",24,65,6d,05),library);
...
HXLINE(  57)				{
HXLINE(  57)					 ::Alphabet _g = optionText1;
HXDLIN(  57)					_g->set_x((_g->x + 280));
            				}
