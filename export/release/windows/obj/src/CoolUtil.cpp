...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_141_camLerpShit,"CoolUtil","camLerpShit",0x1f9a57a3,"CoolUtil.camLerpShit","CoolUtil.hx",141,0x9f143813)
...
Float CoolUtil_obj::camLerpShit(Float daLerp){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_141_camLerpShit)
HXDLIN( 141)		return ((::flixel::FlxG_obj::elapsed / ((Float)0.016666666666666666)) * daLerp);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(CoolUtil_obj,camLerpShit,return )
...
bool CoolUtil_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"camLerpShit") ) { outValue = camLerpShit_dyn(); return true; }
		break;
	case 12:
...
HXDLIN(  19)		defaultDifficulties = ::Array_obj< ::String >::fromData( _hx_array_data_c96d938b_19,3);
            	}
{
