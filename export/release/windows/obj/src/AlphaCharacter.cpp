...
HXDLIN( 435)			_g->set_y((_g->y - (( (Float)(20) ) * this->textSize)));
HXDLIN( 435)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("(",28,00,00,00)) ){
HXLINE( 440)			{
HXLINE( 440)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 440)				_g->set_x((_g->x - (( (Float)(65) ) * this->textSize)));
            			}
HXLINE( 441)			{
HXLINE( 441)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 441)				_g1->set_y((_g1->y - (( (Float)(5) ) * this->textSize)));
            			}
...
HXDLIN( 444)				_g->set_x((_g->x - (( (Float)(20) ) / this->textSize)));
            			}
HXLINE( 445)			{
HXLINE( 445)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 445)				_g1->set_y((_g1->y - (( (Float)(5) ) * this->textSize)));
            			}
HXLINE( 446)			this->offset->set_x((( (Float)(12) ) * this->textSize));
HXLINE( 443)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 438)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 438)			_g->set_y((_g->y + (( (Float)(20) ) * this->textSize)));
HXDLIN( 438)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_1==HX_(".",2e,00,00,00)) ){
HXLINE( 448)			{
HXLINE( 448)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 448)				_g->set_y((_g->y + (( (Float)(45) ) * this->textSize)));
            			}
HXLINE( 449)			{
HXLINE( 449)				 ::AlphaCharacter _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 449)				_g1->set_x((_g1->x + (( (Float)(5) ) * this->textSize)));
            			}
HXLINE( 450)			{
HXLINE( 450)				 ::flixel::math::FlxPoint _g2 = this->offset;
HXDLIN( 450)				_g2->set_x((_g2->x + (( (Float)(3) ) * this->textSize)));
            			}
...
HXLINE( 467)		{
HXLINE( 467)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 467)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
HXDLIN( 478)			_g->set_y((_g->y + (this->row * 60)));
            		}
            	}
...
HXLINE( 491)			{
HXLINE( 491)				 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 491)				_g->set_y((_g->y - ( (Float)(50) )));
            			}
...
HXLINE( 506)		{
HXLINE( 506)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 506)			_g->set_y((_g->y + (this->row * 60)));
            		}
HXLINE( 507)		::String _hx_switch_1 = letter;
            		if (  (_hx_switch_1==HX_("'",27,00,00,00)) ){
HXLINE( 510)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 510)			_g->set_y((_g->y - ( (Float)(20) )));
HXDLIN( 510)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_1==HX_("-",2d,00,00,00)) ){
HXLINE( 513)			 ::AlphaCharacter _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 513)			_g->set_y((_g->y - ( (Float)(16) )));
