...
HXLINE(  53)		{
HXLINE(  53)			 ::Boyfriend _g = this->boyfriend;
HXDLIN(  53)			_g->set_x((_g->x + this->boyfriend->positionArray->__get(0)));
            		}
HXLINE(  54)		{
HXLINE(  54)			 ::Boyfriend _g1 = this->boyfriend;
HXDLIN(  54)			_g1->set_y((_g1->y + this->boyfriend->positionArray->__get(1)));
            		}
