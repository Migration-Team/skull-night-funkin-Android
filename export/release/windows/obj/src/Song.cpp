...
HX_DEFINE_STACK_FRAME(_hx_pos_4e288e2989890fc6_37_new,"Song","new",0xfb6c8f67,"Song.new","Song.hx",37,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_55_onLoadJson,"Song","onLoadJson",0xe02d2786,"Song.onLoadJson","Song.hx",55,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_101_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",101,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_150_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",150,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_37_new)
HXLINE(  52)		this->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  51)		this->player3 = HX_("gf",1f,5a,00,00);
HXLINE(  50)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  49)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  46)		this->speed = ((Float)1);
HXLINE(  43)		this->needsVoices = true;
HXLINE(  95)		this->song = song;
HXLINE(  96)		this->notes = notes;
HXLINE(  97)		this->bpm = bpm;
            	}
...
void Song_obj::onLoadJson( ::Dynamic songJson){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_55_onLoadJson)
HXLINE(  56)		if (::hx::IsNull( songJson->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic) )) {
HXLINE(  58)			songJson->__SetField(HX_("gfVersion",b9,c6,7d,f3),songJson->__Field(HX_("player3",b2,09,15,8a),::hx::paccDynamic),::hx::paccDynamic);
HXLINE(  59)			songJson->__SetField(HX_("player3",b2,09,15,8a),null(),::hx::paccDynamic);
            		}
HXLINE(  62)		if (::hx::IsNull( songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic) )) {
HXLINE(  64)			songJson->__SetField(HX_("events",19,4f,6a,96),::cpp::VirtualArray_obj::__new(0),::hx::paccDynamic);
HXLINE(  65)			{
HXLINE(  65)				int _g = 0;
HXDLIN(  65)				int _g1 = ( (::Array< ::Dynamic>)(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) )->length;
HXDLIN(  65)				while((_g < _g1)){
HXLINE(  65)					_g = (_g + 1);
HXDLIN(  65)					int secNum = (_g - 1);
HXLINE(  67)					 ::Dynamic sec =  ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(secNum);
HXLINE(  69)					int i = 0;
HXLINE(  70)					::cpp::VirtualArray notes = ( (::cpp::VirtualArray)(sec->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXLINE(  71)					int len = notes->get_length();
HXLINE(  72)					while((i < len)){
HXLINE(  74)						::cpp::VirtualArray note = ( (::cpp::VirtualArray)(notes->__get(i)) );
HXLINE(  75)						if (::hx::IsLess( note->__get(1),0 )) {
HXLINE(  77)							( (::cpp::VirtualArray)(songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic)) )->push(::cpp::VirtualArray_obj::__new(2)->init(0,note->__get(0))->init(1,::cpp::VirtualArray_obj::__new(1)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,note->__get(2))->init(1,note->__get(3))->init(2,note->__get(4)))));
HXLINE(  78)							notes->remove(note);
HXLINE(  79)							len = notes->get_length();
            						}
            						else {
HXLINE(  81)							i = (i + 1);
            						}
...
HXLINE(  87)		if (::hx::IsNull( songJson->__Field(HX_("mania",f2,c0,1e,03),::hx::paccDynamic) )) {
HXLINE(  89)			songJson->__SetField(HX_("mania",f2,c0,1e,03),::Note_obj::defaultMania,::hx::paccDynamic);
            		}
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_101_loadFromJson)
HXLINE( 102)		::String rawJson = null();
HXLINE( 104)		::String formattedFolder = ::StringTools_obj::replace(folder.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 105)		::String formattedSong = ::StringTools_obj::replace(jsonInput.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 107)		::String moddyFile = ::Paths_obj::modFolders(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
HXLINE( 108)		if (::sys::FileSystem_obj::exists(moddyFile)) {
HXLINE( 109)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(moddyFile));
            		}
HXLINE( 113)		if (::hx::IsNull( rawJson )) {
HXLINE( 115)			::String library = null();
HXDLIN( 115)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
            		}
HXLINE( 121)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE( 123)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE( 143)		 ::Dynamic songJson = ::Song_obj::parseJSONshit(rawJson);
HXLINE( 144)		if ((jsonInput != HX_("events",19,4f,6a,96))) {
HXLINE( 144)			::StageData_obj::loadDirectory(songJson);
            		}
HXLINE( 145)		::Song_obj::onLoadJson(songJson);
HXLINE( 146)		return songJson;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_150_parseJSONshit)
HXLINE( 151)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE( 152)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE( 153)		return swagShit;
            	}
