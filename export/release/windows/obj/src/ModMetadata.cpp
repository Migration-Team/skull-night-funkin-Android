...
HX_DEFINE_STACK_FRAME(_hx_pos_f8fd466029c4d025_733_new,"ModMetadata","new",0x98e8f1a3,"ModMetadata.new","ModsMenuState.hx",733,0xc380473d)

void ModMetadata_obj::__construct(::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_f8fd466029c4d025_733_new)
HXLINE( 734)		this->folder = folder;
HXLINE( 735)		this->name = folder;
HXLINE( 736)		this->description = HX_("No description provided.",88,46,cb,66);
HXLINE( 737)		this->color = ::ModsMenuState_obj::defaultColor;
HXLINE( 738)		this->restart = false;
HXLINE( 741)		::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 741)		if (::hx::IsNull( key )) {
HXLINE( 741)			key = HX_("",00,00,00,00);
            		}
HXDLIN( 741)		::String path = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 742)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 743)			::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 744)			bool _hx_tmp;
HXDLIN( 744)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 744)				_hx_tmp = (rawJson.length > 0);
            			}
            			else {
HXLINE( 744)				_hx_tmp = false;
            			}
HXDLIN( 744)			if (_hx_tmp) {
HXLINE( 745)				 ::Dynamic stuff =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 747)				::Array< int > colors = ( (::Array< int >)(::Reflect_obj::getProperty(stuff,HX_("color",63,71,5c,4a))) );
HXLINE( 748)				::String description = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("description",fc,08,1d,5f))) );
HXLINE( 749)				::String name = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("name",4b,72,ff,48))) );
HXLINE( 750)				bool restart = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("restart",cf,c7,a5,6a))) );
HXLINE( 752)				bool _hx_tmp;
HXDLIN( 752)				if (::hx::IsNotNull( name )) {
HXLINE( 752)					_hx_tmp = (name.length > 0);
            				}
            				else {
HXLINE( 752)					_hx_tmp = false;
            				}
HXDLIN( 752)				if (_hx_tmp) {
HXLINE( 754)					this->name = name;
            				}
HXLINE( 756)				bool _hx_tmp1;
HXDLIN( 756)				if (::hx::IsNotNull( description )) {
HXLINE( 756)					_hx_tmp1 = (description.length > 0);
            				}
            				else {
HXLINE( 756)					_hx_tmp1 = false;
            				}
HXDLIN( 756)				if (_hx_tmp1) {
HXLINE( 758)					this->description = description;
            				}
HXLINE( 760)				bool _hx_tmp2;
HXDLIN( 760)				if (::hx::IsNotNull( colors )) {
HXLINE( 760)					_hx_tmp2 = (colors->length > 2);
            				}
            				else {
HXLINE( 760)					_hx_tmp2 = false;
            				}
HXDLIN( 760)				if (_hx_tmp2) {
HXLINE( 762)					int Red = colors->__get(0);
HXDLIN( 762)					int Green = colors->__get(1);
HXDLIN( 762)					int Blue = colors->__get(2);
HXDLIN( 762)					int Alpha = 255;
HXDLIN( 762)					int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 762)					{
HXLINE( 762)						color = (color & -16711681);
HXDLIN( 762)						int color1;
HXDLIN( 762)						if ((Red > 255)) {
HXLINE( 762)							color1 = 255;
            						}
            						else {
HXLINE( 762)							if ((Red < 0)) {
HXLINE( 762)								color1 = 0;
...
HXLINE( 762)								color1 = Red;
            							}
            						}
HXDLIN( 762)						color = (color | (color1 << 16));
            					}
HXDLIN( 762)					{
HXLINE( 762)						color = (color & -65281);
HXDLIN( 762)						int color2;
HXDLIN( 762)						if ((Green > 255)) {
HXLINE( 762)							color2 = 255;
            						}
            						else {
HXLINE( 762)							if ((Green < 0)) {
HXLINE( 762)								color2 = 0;
            							}
            							else {
HXLINE( 762)								color2 = Green;
            							}
            						}
HXDLIN( 762)						color = (color | (color2 << 8));
            					}
HXDLIN( 762)					{
HXLINE( 762)						color = (color & -256);
HXDLIN( 762)						int color3;
HXDLIN( 762)						if ((Blue > 255)) {
HXLINE( 762)							color3 = 255;
            						}
            						else {
HXLINE( 762)							if ((Blue < 0)) {
HXLINE( 762)								color3 = 0;
            							}
            							else {
HXLINE( 762)								color3 = Blue;
            							}
            						}
HXDLIN( 762)						color = (color | color3);
            					}
HXDLIN( 762)					{
HXLINE( 762)						color = (color & 16777215);
HXDLIN( 762)						int color4;
HXDLIN( 762)						if ((Alpha > 255)) {
HXLINE( 762)							color4 = 255;
            						}
            						else {
HXLINE( 762)							if ((Alpha < 0)) {
HXLINE( 762)								color4 = 0;
            							}
            							else {
HXLINE( 762)								color4 = Alpha;
            							}
            						}
HXDLIN( 762)						color = (color | (color4 << 24));
            					}
HXDLIN( 762)					this->color = color;
            				}
HXLINE( 765)				this->restart = restart;
            			}
            		}
            	}
