...
HXLINE( 262)					{
HXLINE( 262)						 ::DialogueCharacter _g = _hx_char;
HXDLIN( 262)						Float _g1 = _g->x;
HXDLIN( 262)						_g->set_x((_g1 - (_hx_char->get_width() / ( (Float)(2) ))));
            					}
...
HXLINE( 272)				{
HXLINE( 272)					 ::DialogueCharacter _g = _hx_char;
HXDLIN( 272)					_g->set_x((_g->x +  ::Dynamic(_hx_char->jsonFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(0)));
            				}
HXLINE( 273)				{
HXLINE( 273)					 ::DialogueCharacter _g1 = _hx_char;
HXDLIN( 273)					_g1->set_y((_g1->y +  ::Dynamic(_hx_char->jsonFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(1)));
            				}
...
HXLINE( 293)			{
HXLINE( 293)				 ::flixel::FlxSprite _g = this->bgFade;
HXDLIN( 293)				_g->set_alpha((_g->alpha + (((Float)0.5) * elapsed)));
            			}
...
HXDLIN( 369)									_g->set_y((_g->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 365)								goto _hx_goto_11;
            							...
            							if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 372)								{
HXLINE( 372)									 ::DialogueCharacter _g = _hx_char;
HXDLIN( 372)									_g->set_x((_g->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 371)								goto _hx_goto_11;
            							...
            							_hx_goto_11:;
HXLINE( 375)							{
HXLINE( 375)								 ::DialogueCharacter _g = _hx_char;
HXDLIN( 375)								_g->set_alpha((_g->alpha - (( (Float)(3) ) * elapsed)));
            							}
...
HXDLIN( 383)									_g->set_y((_g->y - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 386)								{
HXLINE( 386)									 ::DialogueCharacter _g = _hx_char;
HXDLIN( 386)									_g->set_x((_g->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
            								}
...
HXLINE( 385)								goto _hx_goto_12;
            							...
            							_hx_goto_12:;
HXLINE( 389)							{
HXLINE( 389)								 ::DialogueCharacter _g = _hx_char;
HXDLIN( 389)								_g->set_alpha((_g->alpha + (( (Float)(3) ) * elapsed)));
            							}
...
HXLINE( 404)				{
HXLINE( 404)					 ::flixel::FlxSprite _g = this->bgFade;
HXDLIN( 404)					_g->set_alpha((_g->alpha - (((Float)0.5) * elapsed)));
            				}
...
HXDLIN( 420)							_g->set_y((_g->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXDLIN( 420)							goto _hx_goto_14;
            						}
            						if (  (_hx_switch_2==HX_("left",07,08,b0,47)) ){
HXLINE( 418)							 ::DialogueCharacter _g = leChar;
HXDLIN( 418)							_g->set_x((_g->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
...
HXDLIN( 424)							_g->set_alpha((_g->alpha - (elapsed * ( (Float)(10) ))));
            						}
            					}
            				}
            			}
...
HXLINE( 539)			 ::flixel::math::FlxPoint _g = box->offset;
HXDLIN( 539)			_g->set_y((_g->y + 10));
            		}
            	}
